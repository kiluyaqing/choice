package org.kiluyaqing.choice.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "choice@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "choice API";

        private String description = "choice API documentation";
