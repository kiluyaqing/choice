(function() {
    ...
    angular
        .module('choiceApp')
        .factory('Investigation', Investigation);

    Investigation.$inject = ['$resource', 'DateUtils'];

    function Investigation ($resource, DateUtils) {
        var resourceUrl =  'api/investigations/:id';
